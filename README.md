...
> *d*<sub>*i*</subreturned by the comparison function must always obey *d*<sub>*i*</sub<=
> *d*<sub>*j*</subwhen *i* <= *j*. As such, you *can* have a data list of numerically *descending* values
